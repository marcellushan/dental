	...
	<?php echo form_open('home/driver'); ?>
		<fieldset>
			...
			<div class="row">
				...
				<div class="col-md-6 col-xs-12">
					<div class="row">
						<label class="col-xs-5">Preferred Phone</label><input type="text" class="col-xs-6" name="preferred_phone" placeholder="required">
						<label class="col-xs-5">Backup Phone</label><input type="text" class="col-xs-6" name="backup_phone" >
						<label class="col-xs-5">Preferred Email</label><input type="text" class="col-xs-6" name="preferred_email" placeholder="required">
						<label class="col-xs-5">Backup Email</label><input type="text" class="col-xs-6" name="backup_email" >
					</div><!-- row -->
				</div><!-- col-md-6 col-xs-12 -->
			</div><!-- row -->
