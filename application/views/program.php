 <div class="main container">
	...
	<form action="submit" method="post">
		<div class="row">
			...
			<div class="col-md-5">
				<h3><input type="radio" name="fulltime" value="1">Fulltime (3 semesters)</h3>
				<h3><input type="radio" name="fulltime" value="0">Part-time (4 semesters)</h3>
			</div><!-- col-md-5 -->
		</div><!-- row -->
		<div class="row">
				<h3 class="col-md-5">How did you hear about our program?</h3>
				<div class="col-md-7">
					<textarea rows="5" class="form-control" cols=""></textarea>
				</div>
		</div><!-- row -->
