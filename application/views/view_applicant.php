	 ...
	 <div>
	    <h2  class= "mytitle">Application Status</h2>
			...
			<h3 class="col-md-5 col-md-offset-2">Application Received</h3>
				...
				<? else:?>
				<div class="col-md-5 col-md-offset-2"> <input type="button" class="btn btn-info btn-lg" onclick="window.location.href='../update/complete/<?=$applicant->applicant_id ?>'" value="Mark Application Complete"></div>
				<? endif;?>
				<? if($applicant->funds):?>
				...
				<? else:?>
					<div class="col-md-5"> <input type="button" class="btn btn-info btn-lg" onclick="window.location.href='../update/funds/<?=$applicant->applicant_id ?>'"value="Application Funds Received"></div>
				<? endif;?>
			</div>
