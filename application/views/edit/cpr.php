...
<form action="../../cpr/put/<?=@$cpr->cpr_id ?>" method="post" id="cpr" enctype="multipart/form-data" onsubmit="return Validate(this);">
...
<input type="date" name="expiration_date" placeholder="required" value="<?php echo set_value('expiration_date'); ?>">
	...
	<input type="submit" class="btn btn-primary btn-lg center-block" value="Update CPR" />
