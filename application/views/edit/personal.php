		...
		<fieldset>
			<h2>Name</h2>
				<div class="row">
                    ...
                    <div class="col-sm-2 col-xs-6" ><input type="text" name="first_name" placeholder="required" value="<?=@$applicant->first_name?>" required></div>
                    ...
                    <div class="col-sm-2 col-xs-6" ><input type="text" name="last_name" placeholder="required"  value="<?=@$applicant->last_name?>"required></div>


				</div><!-- row -->
				<div class="row">
                    <div class="col-sm-2 col-xs-5"><label>Date of Birth</label></div>
                        <div class="col-sm-2 col-xs-6"><input type="date" name="birth_date" placeholder="MM/DD/YYY" value="<?=@$applicant->birth_date ?>" required ></div>
			...
			<div class="row">
				...
				<div class="col-md-6 col-xs-12">
					<div class="row">
						...
						<label class="col-xs-5">Preferred Email</label><input type="text" class="col-xs-6" name="preferred_email" placeholder="required" value="<?=@$applicant->preferred_email?>" disabled>
